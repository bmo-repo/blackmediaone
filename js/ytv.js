...
(function(win, doc) {
	'use strict';
	var apiKey = 'AIzaSyD1eQSYe1iKu8dPyKnBzPgHcVzXOXPTc3c';
	var YTV = YTV || function(id, opts){
		...
		var noop = function(){},
			settings = {
				...
				element: null,
				user: null, 
	playlist: 'PLXuxB8UBb52kPwplvr-0MODgpXtge8k_Y,PLXuxB8UBb52n82gKCWmBMf-QHuZMX7ACg,PLXuxB8UBb52mEatXQ8l398ie_Nhe_YfnJ,PLXuxB8UBb52lg1mTU-AfMpyP-8ZEl_8SJ,PLXuxB8UBb52nR4oq7XZzcxJW4kj7_Q5Zc',
				channelId: null,
				fullscreen: true,
				accent: '#fff',
				controls: false,
							...
							for(i=0; i<videos.length; i++){
								if(videos[i].status.embeddable){
									var video = {
										...
										slug: videos[i].id,
										link: 'https://www.youtube.com/embed/'+videos[i].id+'?rel=0;controls=0;showinfo=0',
